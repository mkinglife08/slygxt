function DragImgUpload(id,options) {
    ...
    this.preview = $('<div id="preview"><img id="img_' + $(id).attr("id") + '" src="' + __curHostAddress + 'Content/images/upload.png" class="img-responsive"  style="width: 100%;height: auto;" alt="" title=""> </div>');
