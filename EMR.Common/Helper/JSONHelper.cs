...
namespace EMR.Common
{
    public static class JSONHelper
    {
        ...
        public static T DeserializeObject<T>(this string data,string datetFormat = "yyyy-MM-dd")
        {

            IsoDateTimeConverter timeFormat = new IsoDateTimeConverter();
            timeFormat.DateTimeFormat = datetFormat; 
        ...
        public static string ToJson(object jsonObject)
        {
            ...
            for (int i = 0; i < propertyInfo.Length; i++)
            {
                ...
                if (objectValue == null)
                {
                    if (propertyInfo[i].PropertyType.Name == "List`1")
                    {
                        value = "[]";
                    }
                    else { value = "\"\""; }
                ...
                else if (objectValue is int || objectValue is decimal)
                {
                    value = objectValue.ToString();
                }
